...
export default function LaborRightsChatbot() {
    ...
    switch (key) {
        ...
        return {
          ...
          content: (
            <div className="space-y-2 text-xs text-slate-700">
              ...
              <div className="bg-amber-50 p-2 rounded-lg text-amber-900">
                <strong>만 18세 미만 청소년 필수 준비서류:</strong><br />
                ① 가족관계증명서 + ② 친권자(후견인) 동의서
              </div>
              <div className="bg-rose-50 p-2 rounded-lg text-rose-900 border-l-4 border-rose-400">
            ...
            <div className="space-y-2 text-xs text-slate-700">
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-3 rounded-xl shadow-xs">
                ...
                <div className="flex items-baseline gap-1.5 mt-0.5">
                  ...
                  <span className="text-[11px] text-blue-100">(월 환산 2,156,880원 / 209h 기준)</span>
                </div>
                <p className="text-[10px] text-blue-200 mt-1">* 2025년 최저임금: 10,030원 | 2024년 최저임금: 9,860원</p>
              </div>
              ...
              <div className="bg-emerald-50 p-2.5 rounded-lg border border-emerald-200 flex items-center justify-between">
                ...
                <button 
                  ...
                  className="bg-emerald-600 hover:bg-emerald-700 text-white text-[11px] px-2.5 py-1.5 rounded-lg font-bold shadow-sm shrink-0 transition cursor-pointer"
                >
                  급여 계산기
                </button>
              </div>
              
              <div className="bg-amber-50 p-2 rounded-lg text-amber-900 border-l-4 border-amber-400">
              ...
              <div className="space-y-1">
                <strong class="text-slate-800 block">💡 임금 지급의 4대 원칙</strong>
      ...
      case "rights_protect":
        return {
          ...
          content: (
            <div className="space-y-2 text-xs text-slate-700">
              <div className="bg-rose-50 p-2 rounded-lg border-l-4 border-rose-400">
            ...
            <div className="space-y-1.5 text-xs text-slate-700">
              <div className="bg-slate-100 p-2 rounded-lg flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">임금체불, 주휴수당 미지급, 근로계약서 미작성</p>
                </div>
              </div>
              <div className="bg-slate-100 p-2 rounded-lg flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">억울한 해고 및 부당 징계 (5인 이상 사업장)</p>
                </div>
              </div>
              <div className="bg-slate-100 p-2 rounded-lg flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">업무상 부상, 질병, 출퇴근 중 사고 치료비</p>
                </div>
              </div>
              <div className="bg-slate-100 p-2 rounded-lg flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">나이, 성별, 신분 등에 따른 차별 및 인권침해</p>
                </div>
              </div>
            </div>
          )
  ...
  const handleSendTextMessage = () => {
    ...
    if (lower.includes("계약서") || lower.includes("근로계약") || lower.includes("작성") || lower.includes("벌금")) {
      matchedKey = "contract";
  ...
  return (
    <div className="py-6 px-4 flex justify-center items-center min-h-[calc(100vh-5rem)] bg-slate-900/90 font-sans">
      <div className="w-full max-w-md h-[82vh] max-h-[820px] bg-slate-100 flex flex-col rounded-3xl shadow-2xl overflow-hidden border-4 border-black relative shadow-[8px_8px_0px_0px_#000]">
        
        {/* Top Header Bar */}
        <header className="bg-white px-4 py-3 border-b-3 border-black flex items-center justify-between z-20 shrink-0 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="w-10 h-10 rounded-full bg-[#ffde59] border-2 border-black flex items-center justify-center text-black font-black text-lg shadow-[2px_2px_0px_0px_#000]">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <h1 className="font-black text-slate-900 text-sm tracking-tight">청소년 노동인권 지킴이</h1>
                <span className="bg-[#5ce1e6] text-black border border-black text-[10px] font-black px-1.5 py-0.5 rounded shadow-[1px_1px_0px_0px_#000]">공인노무사회</span>
              </div>
              <p className="text-[11px] text-slate-600 font-bold">청소년근로권익센터 1:1 맞춤 챗봇</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            <button 
              onClick={() => setIsCalcOpen(true)} 
              className="p-2 text-slate-800 hover:bg-[#ffde59] rounded-xl border-2 border-black shadow-[2px_2px_0px_0px_#000] transition cursor-pointer" 
              title="주휴/알바비 계산기"
            >
            ...
            <button 
              ...
              className="p-2 bg-[#ff5757] text-white hover:bg-rose-600 rounded-xl border-2 border-black shadow-[2px_2px_0px_0px_#000] transition cursor-pointer font-bold" 
              title="권익센터 긴급상담"
            >
            ...
            <button 
              onClick={restartChat} 
              className="p-2 bg-white text-slate-800 hover:bg-slate-200 rounded-xl border-2 border-black shadow-[2px_2px_0px_0px_#000] transition cursor-pointer" 
              title="대화 다시 시작"
            >
        ...
        <main className="flex-1 overflow-y-auto p-4 space-y-4 bg-[#ABC1D1] relative">
          ...
          <div className="flex justify-center my-1">
            <span className="bg-black/40 backdrop-blur-sm text-white text-[11px] px-3 py-1 rounded-full font-bold shadow-sm border border-black/20">
          ...
          {/* Rendered Messages */}
          {messages.map((msg) => (
            <div key={msg.id} className={`flex ${msg.sender === "user" ? "justify-end items-end" : "items-start"} gap-2 animate-fadeIn`}>
              {msg.sender === "bot" && (
                <div className="w-8 h-8 rounded-full bg-[#ffde59] border-2 border-black flex items-center justify-center text-black font-black text-xs shrink-0 shadow-[2px_2px_0px_0px_#000] mt-0.5">
              ...
              {msg.sender === "user" ? (
                <div className="flex items-end gap-1.5 max-w-[80%]">
                  <span className="text-[10px] text-slate-700 font-bold">{msg.time}</span>
                  <div className="bg-[#FEE500] border-2 border-black text-slate-900 px-3.5 py-2.5 rounded-2xl rounded-tr-xs text-xs sm:text-sm font-bold shadow-[2px_2px_0px_0px_#000] leading-relaxed break-words">
                    {msg.content}
                  </div>
                </div>
              ) : (
                <div className="max-w-[85%] space-y-1">
                  <div className="text-[11px] font-black text-slate-900 ml-1">알바지킴이봇</div>
                  <div className="bg-white text-slate-800 p-3.5 rounded-2xl rounded-tl-xs border-2 border-black shadow-[3px_3px_0px_0px_#000] text-xs sm:text-sm leading-relaxed">
                    {msg.title && (
                      <div className="flex items-center gap-1.5 pb-2 mb-2 border-b-2 border-slate-200 font-black text-slate-900 text-xs sm:text-sm">
                      ...
                      <div className="mt-3 pt-2.5 border-t border-slate-200 flex flex-wrap gap-1.5">
                        {msg.actions.map((act) => (
                          <button
                            ...
                            className="text-xs bg-[#5ce1e6] hover:bg-cyan-300 text-black font-black px-2.5 py-1.5 rounded-lg border-2 border-black shadow-[2px_2px_0px_0px_#000] transition active:translate-x-[1px] active:translate-y-[1px] cursor-pointer"
                          >
                            {act.label}
                          </button>
                        ))}
                  ...
                  <span className="text-[10px] text-slate-800 font-bold ml-1">{msg.time}</span>
                </div>
              )}
            </div>
          ))}
          ...
          {isTyping && (
            <div className="flex items-start gap-2 animate-fadeIn">
              <div className="w-8 h-8 rounded-full bg-[#ffde59] border-2 border-black flex items-center justify-center text-xs shrink-0 shadow-[2px_2px_0px_0px_#000]">
                <Bot className="w-4 h-4 text-black" />
              </div>
              <div className="bg-white border-2 border-black px-4 py-3 rounded-2xl rounded-tl-none shadow-[2px_2px_0px_0px_#000] flex items-center gap-1.5">
        ...
        {/* Floating Quick Action Chips & Query Input */}
        <div className="bg-white border-t-3 border-black p-2.5 shrink-0 z-10">
          <div className="flex gap-2 overflow-x-auto pb-2 pt-0.5 px-1 text-xs font-black no-scrollbar">
            <button 
              onClick={() => handleUserSelect("quick_contract")} 
              className="whitespace-nowrap px-3 py-1.5 rounded-full bg-[#ffde59] border-2 border-black text-black shadow-[2px_2px_0px_0px_#000] hover:translate-y-[-1px] transition shrink-0 flex items-center gap-1 cursor-pointer"
            >
              📝 근로계약서
            </button>
            <button 
              onClick={() => handleUserSelect("quick_wage")} 
              className="whitespace-nowrap px-3 py-1.5 rounded-full bg-[#5ce1e6] border-2 border-black text-black shadow-[2px_2px_0px_0px_#000] hover:translate-y-[-1px] transition shrink-0 flex items-center gap-1 cursor-pointer"
            >
              💰 최저임금·주휴수당
            </button>
            <button 
              onClick={() => handleUserSelect("quick_hours")} 
              className="whitespace-nowrap px-3 py-1.5 rounded-full bg-[#7ed957] border-2 border-black text-black shadow-[2px_2px_0px_0px_#000] hover:translate-y-[-1px] transition shrink-0 flex items-center gap-1 cursor-pointer"
            >
              ⏰ 근로·휴게시간
            </button>
            <button 
              onClick={() => handleUserSelect("quick_allowance")} 
              className="whitespace-nowrap px-3 py-1.5 rounded-full bg-[#c892ff] border-2 border-black text-black shadow-[2px_2px_0px_0px_#000] hover:translate-y-[-1px] transition shrink-0 flex items-center gap-1 cursor-pointer"
            >
              ➕ 야간/연장 가산수당
            </button>
            <button 
              onClick={() => handleUserSelect("quick_rights")} 
              className="whitespace-nowrap px-3 py-1.5 rounded-full bg-[#ff66c4] border-2 border-black text-black shadow-[2px_2px_0px_0px_#000] hover:translate-y-[-1px] transition shrink-0 flex items-center gap-1 cursor-pointer"
            >
              🛡️ 해고·산재·괴롭힘
            </button>
            <button 
              onClick={() => handleUserSelect("quick_counseling")} 
              className="whitespace-nowrap px-3 py-1.5 rounded-full bg-[#ff5757] text-white border-2 border-black shadow-[2px_2px_0px_0px_#000] hover:translate-y-[-1px] font-black transition shrink-0 flex items-center gap-1 cursor-pointer"
            >
              📞 1:1 권익상담
            </button>
          </div>
          ...
          <div className="flex items-center gap-2 mt-1 px-1">
            <div className="relative flex-1">
              <input 
                ...
                placeholder="질문해보세요 (예: 주휴수당, 해고, 야간)" 
                className="w-full bg-slate-100 border-2 border-black focus:bg-white focus:outline-none text-xs sm:text-sm rounded-full py-2 pl-4 pr-10 font-bold text-slate-800 placeholder-slate-400 shadow-[2px_2px_0px_0px_#000]"
                onKeyDown={(e) => e.key === "Enter" && handleSendTextMessage()}
              />
              <button 
                onClick={handleSendTextMessage} 
                className="absolute right-1 top-1/2 -translate-y-1/2 w-8 h-8 bg-[#ffde59] hover:bg-amber-400 border-2 border-black text-black rounded-full flex items-center justify-center text-xs font-black transition cursor-pointer shadow-[1px_1px_0px_0px_#000]"
              >
      ...
      {isCalcOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-sm rounded-2xl border-4 border-black shadow-[8px_8px_0px_0px_#000] p-5 overflow-hidden animate-fadeIn space-y-4">
            <div className="flex justify-between items-center pb-3 border-b-3 border-black">
              ...
              <button 
                ...
                className="w-8 h-8 bg-slate-100 hover:bg-slate-200 border-2 border-black rounded-lg flex items-center justify-center font-bold text-black cursor-pointer shadow-[2px_2px_0px_0px_#000]"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="space-y-3.5 text-xs text-slate-700">
              <div>
                <div className="flex justify-between items-center mb-1">
                  <label className="font-black text-slate-800">시급 (원)</label>
                  <div className="flex gap-1">
                    <button 
                      type="button" 
                      onClick={() => setCalcHourlyRate(10320)} 
                      className="text-[10px] bg-[#5ce1e6] hover:bg-cyan-300 text-black border border-black font-black px-1.5 py-0.5 rounded shadow-[1px_1px_0px_0px_#000] cursor-pointer"
                    >
                      2026년 최저(10,320원)
                    </button>
                    <button 
                      ...
                      className="text-[10px] bg-slate-200 hover:bg-slate-300 text-slate-800 border border-black font-bold px-1.5 py-0.5 rounded shadow-[1px_1px_0px_0px_#000] cursor-pointer"
                    >
                      2025년(10,030원)
                    </button>
                  </div>
                ...
                <input 
                  ...
                  className="w-full border-2 border-black rounded-xl p-2 font-black text-slate-900 focus:outline-none focus:bg-amber-50 shadow-[2px_2px_0px_0px_#000]" 
                  placeholder="시급 입력"
                />
                <p className="text-[11px] text-slate-500 font-bold mt-1">* 2026년 법정 최저시급: <span className="text-blue-600 font-black">10,320원</span> (미만 지급 시 불법)</p>
              </div>

              <div>
                <label className="font-black text-slate-800 block mb-1">1주 총 일하는 시간 (시간)</label>
                <input 
                  type="number" 
                ...
                />
                <p className="text-[11px] text-blue-600 font-bold mt-1">💡 청소년 법정 근로시간: 주 35시간 이내</p>
              </div>

              <div className="bg-slate-50 p-3.5 rounded-xl border-2 border-black shadow-[3px_3px_0px_0px_#000] space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-slate-600 font-bold">기본 주급</span>
                  <span className="font-black text-slate-900">{baseWeeklyPay.toLocaleString()}원</span>
                </div>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-1">
                    <span className="text-slate-600 font-bold">주휴수당 예상</span>
                    <span className={`text-[10px] font-black px-1.5 py-0.2 rounded border border-black shadow-[1px_1px_0px_0px_#000] ${isHolidayEligible ? "bg-[#7ed957] text-black" : "bg-slate-200 text-slate-600"}`}>
                      {isHolidayEligible ? "지급 대상 (15h 이상)" : "미해당 (15h 미만)"}
                    </span>
                  </div>
                  <span className="font-black text-emerald-600">+{holidayPay.toLocaleString()}원</span>
                </div>
            ...
            <div className="mt-5 flex gap-2">
              <button 
                onClick={() => setIsCalcOpen(false)} 
                className="flex-1 bg-slate-200 hover:bg-slate-300 text-black border-2 border-black font-black py-2.5 rounded-xl text-xs shadow-[2px_2px_0px_0px_#000] cursor-pointer transition"
              >
                닫기
              </button>
              <button 
                onClick={sendCalculatedToChat} 
                className="flex-1 bg-[#ffde59] hover:bg-amber-400 text-slate-900 border-2 border-black font-black py-2.5 rounded-xl text-xs shadow-[2px_2px_0px_0px_#000] cursor-pointer transition"
              >
                챗봇에 공유하기
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-sm rounded-2xl border-4 border-black shadow-[8px_8px_0px_0px_#000] p-5 overflow-hidden animate-fadeIn space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3 bg-blue-50 border-2 border-black rounded-xl shadow-[3px_3px_0px_0px_#000]">
                <div className="flex items-center gap-2 text-blue-900 font-black mb-1 text-sm">
                ...
                <div className="flex gap-2">
                  <a 
                    href="tel:1644-3119" 
                    className="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-center py-2 rounded-lg font-black border-2 border-black shadow-[2px_2px_0px_0px_#000] flex items-center justify-center gap-1.5"
                  >
                    <Phone className="w-4 h-4" /> 1644-3119 전화
                  </a>
                  <button 
                    onClick={copyPhone} 
                    className="px-3 bg-white border-2 border-black text-slate-900 rounded-lg hover:bg-slate-100 font-black shadow-[2px_2px_0px_0px_#000] cursor-pointer"
                  >
              ...
              <div className="p-3 bg-slate-50 border-2 border-black rounded-xl shadow-[3px_3px_0px_0px_#000] space-y-1.5">
                <div className="font-black text-slate-900 text-xs">기타 기관 안내</div>
                <div className="flex justify-between text-slate-700 text-[11px]">
                  <span>· 고용노동부 (임금체불/근로기준)</span>
                  <span className="font-black text-slate-900">국번없이 1350</span>
                </div>
                <div className="flex justify-between text-slate-700 text-[11px]">
                  <span>· 근로복지공단 (산업재해보상)</span>
                  <span className="font-black text-slate-900">1588-0075</span>
                </div>
                <div className="flex justify-between text-slate-700 text-[11px]">
                  <span>· 국가인권위원회 (차별/인권침해)</span>
                  <span className="font-black text-slate-900">국번없이 1331</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4">
              <button 
                onClick={() => setIsHelpOpen(false)} 
                className="w-full bg-slate-200 hover:bg-slate-300 text-slate-900 border-2 border-black font-black py-2 rounded-xl text-xs shadow-[2px_2px_0px_0px_#000] cursor-pointer"
              >
                닫기
              </button>
            </div>
      ...
      {/* Toast */}
      {toastMessage && (
        <div className="fixed bottom-10 left-1/2 -translate-x-1/2 bg-black text-white text-xs font-bold px-4 py-2.5 rounded-full border-2 border-white shadow-2xl z-50 animate-fadeIn">
          {toastMessage}
        </div>
      )}
    </div>
