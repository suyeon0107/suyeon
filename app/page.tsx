...
export default function Home() {
  return (
    <div className="relative isolate flex flex-col items-center justify-start px-4 py-12 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-50/50 via-zinc-50 to-zinc-50 dark:from-indigo-950/20 dark:via-zinc-950 dark:to-zinc-950 min-h-[calc(100vh-8rem)]">
      {/* 백그라운드 디자인 데코레이션 */}
      <div
